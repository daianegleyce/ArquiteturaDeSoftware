...
insert into previsao (id, temperatura_minima, temperatura_maxima, humidade_ar, descricao, data_hora, latitude, longitude, id_dia_semana) values (1, 10.0, 18.7, 86, 'Nublado', '24/03/2019 22:30', 22.0, 34.0, 1);
